...
const teamMembers = [
  ...
  // },
  {
    ...
    description: "สวัสดีครับ! เราชื่อโม ",
    details: "เรารับผิดชอบในการออกแบบ UI สำหรับระบบรายงาน (Report) และเก็บสถิติ รวมถึงการวางแผนรายละเอียดและระยะเวลาในการทำงาน การสัมภาษณ์ผู้ใช้เพื่อเก็บข้อมูลความต้องการ (User Requirements) และเขียนโค้ดที่ตอบโจทย์การใช้งานจริง",
    link: "https://www.instagram.com/_mn.eo_mo/",
  },
  {
    name: "นายวรากร มาตุเรศ 66049472",
    imageClass: "mike-image",
    description: "สวัสดีครับ! เราชื่อวิค ",
  ...
  },
  {
    ...
    description: "สวัสดีค่ะ! เราชื่อกลอยใจ ",
